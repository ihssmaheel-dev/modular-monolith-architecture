...
- Routes parse params, compose feature helpers, and render UI. They do not contain API calls or business logic.
...
- Never call `fetch` directly from routes or features; use `getApiClient()`.
...
- File limits: route ≤400 lines, feature ≤300, lib ≤200, store ≤150, UI primitive ≤500. Split by responsibility before exceeding a limit.
