...
export const organizationsContract = oc.prefix("/tenancy").router({
  ...
  createOrganization: oc
    .route({ method: "POST", path: "/organizations", summary: "Create an organization and owner membership" })
    .input(CreateOrganizationSchema)
    .output(OrganizationResponseSchema),
  listOrganizations: oc
    .route({ method: "GET", path: "/organizations", summary: "List organizations for the authenticated user" })
